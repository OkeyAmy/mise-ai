 ...
 * 
 * This module provides functions for encoding, decoding, and processing audio data
 * for real-time communication with the Gemini Live API.
 */

// Interface for audio data parts that will be sent to Gemini
...
function createBlob(data: Float32Array): AudioDataPart {
  ...
  return {
    ...
    mimeType: 'audio/pcm;rate=16000', // Standard MIME type for 16kHz PCM audio
  };
}
...
// --- Perlin Noise 1D Implementation for AI Bot Visualization ---
...
/**
 * Generates 1D Perlin noise for audio visualization effects
 * @param x - Input value for noise generation
